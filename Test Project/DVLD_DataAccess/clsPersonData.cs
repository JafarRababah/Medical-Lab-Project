    ...
    public class clsPersonData
    {
        ...
        public static bool GetPersonInfoByID(int PersonID, ref string FirstName, ref string SecondName,
          ref string ThirdName, ref string LastName, ref string NationalNo, ref DateTime DateOfBirth,
           ...
           ref int NationalityCountryID,ref string MaritalStatus, ref string ImagePath)
        {
            bool isFound = false;
        ...
        public static int AddNewPerson( string FirstName,  string SecondName,
           ...
           short Gendor, string Address,  string Phone,  string Email,
            int NationalityCountryID,string MaritalStatus,  string ImagePath)
        {
            ...
            string query = @"INSERT INTO People (FirstName, SecondName, ThirdName,LastName,NationalNo,
                                                   DateOfBirth,Gendor,Address,Phone, Email, NationalityCountryID,MaritalStatus,ImagePath)
            ...
            if (MaritalStatus != "" && MaritalStatus != null)
                ...
                command.Parameters.AddWithValue("@MaritalStatus", System.DBNull.Value);
