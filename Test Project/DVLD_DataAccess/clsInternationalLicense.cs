...
namespace DVLD_DataAccess
{
    public class clsInternationalLicenseData
    {
        ...
        public static bool GetInternationalLicenseInfoByID(int InternationalLicenseID, 
            ...
            ref int PatientID, ref int IssuedUsingLocalLicenseID, 
         ...
         public static DataTable GetAllInternationalLicenses()
            ...
            string query = @"
            SELECT    InternationalLicenseID, ApplicationID,PatientID,
         ...
         public static DataTable GetPatientInternationalLicenses(int PatientID)
        {
            ...
            SELECT    InternationalLicenseID, ApplicationID,
		                IssuedUsingLocalLicenseID , IssueDate, 
                        ExpirationDate, IsActive
		    from InternationalLicenses where PatientID=@PatientID
        ...
        public static int AddNewInternationalLicense( int ApplicationID,
             int PatientID,  int IssuedUsingLocalLicenseID,
        ...
        public static int GetActiveInternationalLicenseIDByPatientID(int PatientID)
        {
            ...
            string query = @"  
                            ...
                            FROM InternationalLicenses 
                            where PatientID=@PatientID and GetDate() between IssueDate and ExpirationDate 
                            order by ExpirationDate Desc;";
