...
namespace DVLD_Buisness
{
    public   class clsApplication
    {
        ...
        public enum enApplicationType {
            ...
            ReplaceDamagedDrivingLicense=4, ReleaseDetainedDrivingLicsense=5, RetakeTest = 6, NewInternationalLicense=16
        };
        ...
        private clsApplication(int ApplicationID, int ApplicantPersonID, 
            DateTime ApplicationDate, int ApplicationTypeID,
             ...
             float PaidFees,string Doctor, int CreatedByUserID)
        ...
        private bool _AddNewApplication()
        {
            ...
            this.ApplicationID = clsApplicationData.AddNewApplication(
                ...
                this.LastStatusDate, this.PaidFees,this.Doctor, this.CreatedByUserID);
        ...
        public  static clsApplication FindBaseApplication(int ApplicationID)
        {
            ...
            float PaidFees = 0  ;string Doctor = "";  int CreatedByUserID = -1;
            ...
            bool IsFound = clsApplicationData.GetApplicationInfoByID 
                                (
                                    ...
                                    ref  PaidFees,ref Doctor, ref  CreatedByUserID
                                );
            ...
            if (IsFound)
                ...
                return new clsApplication(ApplicationID,  ApplicantPersonID,
                                    ...
                                    (enApplicationStatus) ApplicationStatus,  LastStatusDate,
                                     PaidFees, Doctor,  CreatedByUserID);
            else
                return null;
        }
        ...
        {
            return clsApplicationData.GetAllDoctors();
