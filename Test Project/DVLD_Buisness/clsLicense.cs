...
namespace DVLD_Buisness
{
    public class clsLicense
    {
        ...
        public clsLicense(int LicenseID,int ApplicationID, int PatientID, int LicenseClass,
        ...
        private bool _AddNewLicense()
        {
            ...
            this.LicenseID = clsLicenseData.AddNewLicense(this.ApplicationID, this.PatientID,
        ...
        private bool _UpdateLicense()
        {
            ...
            return clsLicenseData.UpdateLicense(this.ApplicationID, this.LicenseID, this.PatientID, this.LicenseClass,
               this.IssueDate, this.ExpirationDate, this.Notes, this.PaidFees,
               this.IsActive,(byte) this.IssueReason, this.CreatedByUserID);
        }
        ...
        {
            int ApplicationID = -1; int PatientID = -1; int LicenseClass = -1;
            DateTime IssueDate = DateTime.Now; DateTime ExpirationDate = DateTime.Now;
            string Notes = "";
            float PaidFees = 0; bool IsActive = true; int CreatedByUserID = 1;
            byte IssueReason = 1;
            if (clsLicenseData.GetLicenseInfoByID(LicenseID,ref ApplicationID, ref PatientID,
            ref IssueDate, ref ExpirationDate, ref Notes,
            ref PaidFees, ref IsActive,ref IssueReason, ref CreatedByUserID))

                return new clsLicense(LicenseID,ApplicationID, PatientID, LicenseClass,
        ...
        public static bool IsLicenseExistByPersonID(int PersonID)
        {
            return (GetActiveLicenseIDByPersonID(PersonID) != -1);
        }

        public static int GetActiveLicenseIDByPersonID(int PersonID)
        {

            return clsLicenseData.GetActiveLicenseIDByPersonID(PersonID);

        }

        public static DataTable GetPatientLicenses(int PatientID)
        {
            return clsLicenseData.GetPatientLicenses(PatientID);
        }
        ...
        public bool ReleaseDetainedLicense(int ReleasedByUserID,ref int ApplicationID)
        {
            ...
            Application.ApplicantPersonID = this.PatientInfo.PersonID;
        ...
        public clsLicense RenewLicense(string Notes, int CreatedByUserID)
        {
            ...
            NewLicense.PatientID = this.PatientID;
