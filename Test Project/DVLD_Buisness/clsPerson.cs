       ...
       // public string DepartmentID { set; get; }
        ...
        private bool _AddNewPerson()
        {
            ...
            this.PersonID = clsPersonData.AddNewPerson(
                ...
                this.NationalityCountryID,this.MaritalStatus, this.ImagePath);
        ...
        public static clsPerson Find(int PersonID)
        {
            ...
            bool IsFound = clsPersonData.GetPersonInfoByID 
                                (
                                    ...
                                    ref NationalityCountryID,ref MaritalStatus, ref ImagePath
                                );

            if (IsFound)
                //we return new object of that person with the right data
                return new clsPerson(PersonID, FirstName,SecondName ,ThirdName, LastName,
                          NationalNo, DateOfBirth,Gendor, Address, Phone, Email,NationalityCountryID, MaritalStatus, ImagePath);
            else
                return null;
        }
