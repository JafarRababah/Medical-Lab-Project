...
{
    public partial class frmIssuePatientFileFirstTime : Form
    {
        private int _LocalDrivingLicenseApplicationID;
        private  clsLocalDrivingLicenseApplication _LocalDrivingLicenseApplication;

        public frmIssuePatientFileFirstTime(int LocalDrivingLicenseApplicationID)
        {
            InitializeComponent();
        ...
        private void frmIssuePatientLicenseFirstTime_Load(object sender, EventArgs e)
        {
