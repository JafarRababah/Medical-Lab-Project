    ...
    public partial class frmApplicationsList : Form
    {
        ...
        private void frmListLocalDrivingLicesnseApplications_Load(object sender, EventArgs e)
        {
            ...
            if (dgvLocalDrivingLicenseApplications.Rows.Count>0)
            {
                ...
                dgvLocalDrivingLicenseApplications.Columns[1].HeaderText = "National No.";
                dgvLocalDrivingLicenseApplications.Columns[1].Width = 150;

                dgvLocalDrivingLicenseApplications.Columns[2].HeaderText = "Full Name";
                dgvLocalDrivingLicenseApplications.Columns[2].Width = 350;

                dgvLocalDrivingLicenseApplications.Columns[3].HeaderText = "Application Date";
                dgvLocalDrivingLicenseApplications.Columns[3].Width = 170;
        ...
        private void showDetailsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmApplicationInfo frm =
                        new frmApplicationInfo((int)dgvLocalDrivingLicenseApplications.CurrentRow.Cells[0].Value);
            frm.ShowDialog();
            //refresh
        ...
        private void editToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            frmAddUpdateApplication frm =
                         new frmAddUpdateApplication(LocalDrivingLicenseApplicationID);
            frm.ShowDialog();
        ...
        private void issueDrivingLicenseFirstTimeToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            int LocalDrivingLicenseApplicationID = (int)dgvLocalDrivingLicenseApplications.CurrentRow.Cells[0].Value;
            frmIssuePatientFileFirstTime frm = new frmIssuePatientFileFirstTime(LocalDrivingLicenseApplicationID);
            frm.ShowDialog();
            //refresh
            frmListLocalDrivingLicesnseApplications_Load(null, null);
        }
        ...
        private void cmsApplications_Opening(object sender, CancelEventArgs e)
        {
                ...
                int TotalPassedTests = (int)dgvLocalDrivingLicenseApplications.CurrentRow.Cells[4].Value;
        ...
        private void showLicenseToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (LicenseID != -1)
            {
                frmShowFileInfo frm = new frmShowFileInfo(LicenseID);
                frm.ShowDialog();
        ...
        private void showPersonLicenseHistoryToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            frmShowPersonAppHistory frm = new frmShowPersonAppHistory(localDrivingLicenseApplication.ApplicantPersonID);
            frm.ShowDialog();
        }
