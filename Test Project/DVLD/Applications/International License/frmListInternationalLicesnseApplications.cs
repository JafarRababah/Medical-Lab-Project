    ...
    public partial class frmListInternationalLicesnseApplications : Form
    {
        ...
        private void frmListInternationalLicesnseApplications_Load(object sender, EventArgs e)
        {
            ...
            if (dgvInternationalLicenses.Rows.Count > 0)
            {
                ...
                dgvInternationalLicenses.Columns[2].HeaderText = "Patient ID";
        ...
        private void PesonDetailsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            int PatientID = (int)dgvInternationalLicenses.CurrentRow.Cells[2].Value;
            int PersonID = clsPatient.FindByPatientID(PatientID).PersonID;
