...
namespace DVLD.People
{
    public partial class frmAddUpdatePerson : Form
    {
        ...
        private void _ResetDefualtValues()
        {
            ...
            cbMaritalStatus.SelectedIndex = cbMaritalStatus.FindString("Customers Services");
            txtFirstName.Text = "";
            txtSecondName.Text = "";
            txtThirdName.Text = "";
            txtLastName.Text = "";
        ...
        //    {
        //        cbMaritalStatus.Items.Add(row["DepartmentName"]);
        //    }
        //}
        ...
        private void _LoadData()
        {
            ...
            cbMaritalStatus.SelectedItem = _Person.MaritalStatus;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
           ...
           if (! _HandlePersonImage())
            ...
            string MaritalStatus = cbMaritalStatus.Text;
            ...
            _Person.MaritalStatus = MaritalStatus;
            
            if (pbPersonImage.ImageLocation != null)
                _Person.ImagePath = pbPersonImage.ImageLocation;
            else
                _Person.ImagePath = "";
           // MessageBox.Show(MaritalStatus);
            if (_Person.Save())
            {
