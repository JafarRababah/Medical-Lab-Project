...
{
    public partial class ctrlScheduleApplication : UserControl
    {
        ...
        public ctrlScheduleApplication()
        {
            InitializeComponent();
        }
        ...
        private void ctrlScheduleApplication_Load(object sender, EventArgs e)
        {
